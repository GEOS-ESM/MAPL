  ...
  subroutine scale_field_(offset, scale_factor, field, rc)
   ...
   ! ............................................................................
     ...
     subroutine CreateTimeInterval(item,clock,rc)
        ...
        if (.not.item%hasFileReffTime) then
           ...
           if (lasttoken.gt.0) then
              ...
              select case(token)
              ! Pass item%frequency_is_constant for GCHP in calls to ESMF_TimeIntervalSet
              case("y4")
     ...
     subroutine UpdateBracketTime(item,cTime,currTime,bSide,interpTime,fileTime,file_processed,allowExtrap,rc)
        ...
        ! GCHP: make this debug rather than info
...
! ----------
 ...
 END SUBROUTINE MAPL_ExtDataExtractIntegers
  ...
  ! GCHP: extra prints
  call lgr%debug('   --> MAPL_ExtDataFillField: filling %i3 level input to %i3 levels for %a', lm_in, lm_out, trim(item%name))
