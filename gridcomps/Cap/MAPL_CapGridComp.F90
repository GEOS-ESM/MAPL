...
1002         FORMAT('  MAPL_CapGC running step ', i3, ' of ', i3)
          ...
          if (.not.cap%lperp) then
             ...
             if ( reverse_time == 1 ) then
                ...
                if (MAPL_Am_I_Root() .and. done) THEN
                   ...
                   call ESMF_ClockPrint(cap%clock_hist, options='stopTime string', _RC )
  ...
  contains
     ...
     subroutine print_throughput(rc)
        ...
        ! Change 'AGCM' to 'GCHP' in date string printed to log
    1000 format(1x,'GCHP Date: ',i4.4,'/',i2.2,'/',i2.2,2x,'Time: ',i2.2,':',i2.2,':',i2.2, &
