...
contains
   ...
   subroutine advertise_time_max_internal_fields(gridcomp, name, item_type, rc)
      ...
      call MAPL_GridCompAddSpec(gridcomp, ESMF_STATEINTENT_INTERNAL, 'temp_max'//just_name, fill_value=0.0, itemtype=item_type, _RC)

      _RETURN(_SUCCESS)
   end subroutine advertise_time_max_internal_fields

end module mapl_TimeMax_mod
