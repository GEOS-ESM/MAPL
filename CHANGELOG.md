...
- Added write_lev_first option to trajectory and mask sampler code. The corresponding keyword in the collection is output_leading_dim, default to 'lev'. This is for sampler only.
