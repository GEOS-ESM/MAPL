...
- Fixed bug in climatology hanlding of data in ExtDataV2 that occured depending on the start date of the appliction relative to the length of the application run time
