...
program checkpoint_tester
   ...
   if (rank == 0) then
      ...
      write(*,'(A,L1,L1,L1,L1,L1,L1,L1)')"Split file, 3D_gather, chunk, extra, netcdf output, write barrier, do writes:  ",support%split_file,support%gather_3d,support%do_chunking,support%extra_info,support%netcdf_writes,support%write_barrier,support%do_writes
