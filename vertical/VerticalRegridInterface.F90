...
module VerticalRegridInterfaceMod
   use PFIO
   ...
   public remap_array_mass_mixing
   public remap_array_emission
   public mass_mixing
...
contains
    ...
    subroutine remap_array_mass_mixing(src_pressure, src_values, dst_pressure, dst_values)
       real, intent(in) :: src_pressure(:,:,:)
       real, intent(in) :: src_values(:,:,:)
       real, intent(in) :: dst_pressure(:,:,:)
    ...
    end subroutine remap_array_mass_mixing

    subroutine remap_array_emission(src_pressure, src_values, dst_pressure, dst_values)
       real, intent(in) :: src_pressure(:,:,:)
       real, intent(in) :: src_values(:,:,:)
       real, intent(in) :: dst_pressure(:,:,:)
       real, intent(inout) :: dst_values(:,:,:)
    ...
    end subroutine remap_array_emission


end module VerticalRegridInterfaceMod
