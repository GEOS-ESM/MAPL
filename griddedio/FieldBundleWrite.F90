...
module MAPL_ESMFFieldBundleWrite
   ...
   contains
      ...
      subroutine write_bundle_single_time(bundle,clock,output_file,nbits,deflate,zstandard_level,rc)
         ...
         call newWriter%create_from_bundle(bundle,clock,output_file=output_File,n_steps=1,time_interval=0,nbits=nbits,deflate=deflate,zstandard_level=zstandard_level,rc=status)
         _VERIFY(status)
      ...
      subroutine create_from_bundle(this,bundle,clock,output_file,n_steps,time_interval,nbits,deflate,zstandard_level,rc)
         ...
         call this%cfio%set_param(nbits=nbits,deflation=deflate,zstandard_level=zstandard_level)
