...
contains
   ...
   function mk_grid(grid_name, rc) result(grid)
      ...
      grid = ESMF_GridCreateNoPeriDim(countsPerDeDim1=[2,2], countsPerDeDim2=[2,2], indexflag=INDEX_FLAG_DEFAULT, name = grid_name, __RC)
   ...
   function mk_field_r4_ungrid(name, ungriddedLBound, ungriddedUBound, rc) result(field)
      ...
      field = mk_field_common(tk = ESMF_TYPEKIND_R4, name = name, ungriddedLBound=ungriddedLBound, ungriddedUBound=ungriddedUBound, __RC)
   ...
   function mk_field_r4_2d(farray, name, rc) result(field)
      ...
      field = mk_field_common(tk = ESMF_TYPEKIND_R4, name = name, __RC)
      call ESMF_FieldGet(field, farrayPtr = ptr, __RC)
   ...
   function mk_field_r8_2d(farray, name, rc) result(field)
      ...
      field = mk_field_common(tk = ESMF_TYPEKIND_R8, name = name, __RC)
      call ESMF_FieldGet(field, farrayPtr = ptr, __RC)
      ptr = farray
   ...
   function mk_field_common(tk, name, ungriddedLBound, ungriddedUBound, rc) result(field)
      ...
      grid = mk_grid(grid_name = name // GRID_SUFFIX, __RC)
      field = ESMF_FieldCreate(grid, typekind = tk, name = name // FIELD_SUFFIX, ungriddedLBound = ungriddedLBound, ungriddedUBound = ungriddedUBound, __RC)
   ...
   subroutine initialize_array_R4(x, xmin, xrange)
      ...
      __ASSERT(xrange > 0, 'Range for random numbers must be positive.')
   ...
   function mk_r4field(r4array, field_name, rc) result(r4field)
      ...
      r4field = mk_field(r4array, name = field_name, __RC)
   ...
   function mk_r8field(r8array, field_name, rc) result(r8field)
      ...
      r8field = mk_field(r8array, name = field_name, __RC)
   ...
   function mk_r4ungrid_field(field_name, lbound, ubound, rc) result(r4field)
      ...
      r4field = mk_field_r4_ungrid(name = field_name, ungriddedLBound=[lbound],ungriddedUBound=[ubound],__RC)
