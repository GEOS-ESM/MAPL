...
contains
   ...
   subroutine import_yaml_file(this,yaml_file,unusable, rc) 
      class(historyconfig),             intent(inout) :: this
      character(len=*),                 intent(inout) :: yaml_file
      class(keywordenforcer), optional, intent(  out) :: unusable
      integer,                optional, intent(  out) :: rc
      ...
      p=parser('core')
      file_stream=FileStream(yaml_file)
   ...
   end subroutine import_yaml_file
