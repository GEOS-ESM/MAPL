...
contains
   ...
   module function parse_var_specs(hconfig, timeStep, runTime, rc) result(var_specs)
      ...
      call parse_state_specs(var_specs, subcfg, COMPONENT_INTERNAL_STATE_SECTION,  timeStep, runTime, _RC)
      call parse_state_specs(var_specs, subcfg, COMPONENT_EXPORT_STATE_SECTION, timeStep, runTime, _RC)
      call parse_state_specs(var_specs, subcfg, COMPONENT_IMPORT_STATE_SECTION, timeStep, runTime, _RC)
   ...
   contains
      ...
      subroutine parse_state_specs(var_specs, hconfig, state_intent, timeStep, runTime, rc)
