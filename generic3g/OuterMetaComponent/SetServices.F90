...
contains
   ...
   recursive module subroutine SetServices_(this, rc)
      ...
      ! Note that Parent component should set timestep and refTime_offset in outer meta before calling SetServices.
      this%component_spec = parse_component_spec(this%hconfig, this%registry, this%user_timeStep, this%user_refTime_offset, _RC)
