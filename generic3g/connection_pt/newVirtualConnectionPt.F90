...
module mapl3g_newVirtualConnectionPt
   use mapl_KeywordEnforcer
   use esmf
   implicit none
   private
  
   public :: newVirtualConnectionPt
...
contains
   ...
   function new_VirtualPt_string_intent(unusable, state_intent, short_name) result(v_pt)
      ...
      v_pt = newVirtualConnectionPt(stateintent, short_name)
   ...
   logical function less_than(lhs, rhs)
      type(newVirtualConnectionPt), intent(in) :: lhs
      type(newVirtualConnectionPt), intent(in) :: rhs
