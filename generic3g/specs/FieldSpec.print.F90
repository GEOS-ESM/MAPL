...
contains
   ...
   subroutine print(this)
      ...
      print *, "FieldSpec:"
      print *, "  VerticalDimSpec: ", this%vertical_dim_spec
      if (allocated(this%standard_name)) print *, "  standard name: ", this%standard_name
      if (allocated(this%long_name)) print *, "  long_name: ", this%long_name
      if (allocated(this%units)) print *, "  units: ", this%units
...
!#      this%regrid_param = EsmfRegridderParam(regridmethod=regrid_method)
  ...
  function get_payload(this) result(payload)
   ...
   function new_VerticalGridAdapter(vertical_grid, vertical_dim_spec, geom, typekind, units, regrid_method) result(adapter)
