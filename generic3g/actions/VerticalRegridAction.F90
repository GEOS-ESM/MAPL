...
module mapl3g_VerticalRegridAction
   ...
   type, extends(ExtensionAction) :: VerticalRegridAction
      type(ESMF_Field) :: src_vertical_coord
      type(ESMF_Field) :: dst_vertical_coord
...
contains
   ...
   function new_VerticalRegridAction(src_vertical_coord, dst_vertical_coord, regrid_method) result(action)
      ...
      type(ESMF_Field), intent(in) :: src_vertical_coord
      type(ESMF_Field), intent(in) :: dst_vertical_coord
