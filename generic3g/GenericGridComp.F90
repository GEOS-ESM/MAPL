...
contains
   ...
   contains
      ...
      subroutine set_entry_points(gridcomp, rc)
         ...
         call ESMF_GridCompSetEntryPoint(gridcomp, ESMF_METHOD_INITIALIZE, initialize, phase=GENERIC_INIT_MODIFY_ADVERTISE2, _RC)
...
!#         call ESMF_GridCompSetEntryPoint(gridcomp, ESMF_METHOD_INITIALIZE, initialize, phase=GENERIC_INIT_RESTORE, _RC)
   ...
   recursive subroutine initialize(gridcomp, importState, exportState, clock, rc)
      ...
      case (GENERIC_INIT_MODIFY_ADVERTISE2)
         call outer_meta%initialize_modify_advertise(importState, exportState, clock, _RC)
