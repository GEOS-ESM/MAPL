module r_mapl_FileSystemUtilities
   implicit none
   private
...
end module r_Mapl_FileSystemUtilities

module r_mapl_DSO_Utilities
   use r_mapl_FileSystemUtilities
   implicit none
   ...
   character(*), parameter :: SYSTEM_DSO_EXTENSION = '.dylib'
...
end module r_mapl3g_ESMF_Interfaces
...
module r_mapl3g_UserSetServices
   ...
   use :: r_mapl3g_ESMF_Interfaces, only: I_SetServices
   implicit none
   private
