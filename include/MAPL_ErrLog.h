...
#    define _ASSERT_MSG_AND_LOC_AND_RC_SUCCESS(A,B,C,msg,stat,file,line,rc)  if(MAPL_Assert(A,B,C,msg,stat,file,line __rc(rc))) __return
#    define _ASSERT_MSG_AND_LOC_AND_RC_ANDOP(A,B,msg,stat,file,line,rc)  if(MAPL_Assert(A,B,msg,stat,file,line __rc(rc))) __return
...
#    define _ASSERT_MSG_AND_LOC_SUCCESS(A,B,C,msg,stat,file,line) _ASSERT_MSG_AND_LOC_AND_RC_SUCCESS(A,B,C,msg,stat,file,line,rc)
#    define _ASSERT_MSG_AND_LOC_ANDOP(A,B,msg,stat,file,line) _ASSERT_MSG_AND_LOC_AND_RC_ANDOP(A,B,msg,stat,file,line,rc)
! Assumes __FILE__ and __LINE__ are appropriate
#    define _ASSERT(A,msg) _ASSERT_MSG_AND_LOC(A,msg,1,_FILE_,__LINE__)
#    define _ASSERT_SUCCESS(A,B,msg) _ASSERT_MSG_AND_LOC_SUCCESS(A,B,_SUCCESS,msg,1,_FILE_,__LINE__)
#    define _ASSERTS(A,B,msg) _ASSERT_MSG_AND_LOC_ANDOP(A,B,msg,1,_FILE_,__LINE__)
