...
contains
   ...
   contains
      ...
      subroutine set_entry_points(gridcomp, rc)
         ...
         call ESMF_GridCompSetEntryPoint(gridcomp, ESMF_METHOD_INITIALIZE, initialize, phase=GENERIC_INIT_REALIZE_METADATA, _RC)
   ...
   recursive subroutine initialize(gridcomp, importState, exportState, clock, rc)
      ...
      case (GENERIC_INIT_REALIZE_METADATA)
         call outer_meta%initialize_realize_metadata(importState, exportState, clock, _RC)
