...
module mapl_field_api
   ...
   use mapl_FieldApplyUserRoutine_mod, only: MAPL_FieldGetSliceAsField => FieldGetSliceAsField
   ...
   public :: MAPL_FieldGetSliceAsField
