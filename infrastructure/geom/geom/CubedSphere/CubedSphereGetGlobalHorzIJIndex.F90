...
module mapl_CubedSphereGetGlobalHorzIJIndex_mod
  ...
  use mapl_Constants_mod,   only: MAPL_PI_R8, MAPL_DEGREES_TO_RADIANS_R8
...
end module mapl_CubedSphereGetGlobalHorzIJIndex_mod
