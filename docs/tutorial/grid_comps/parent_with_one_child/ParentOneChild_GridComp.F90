...
module ParentOneChild_GridComp
  ...
  subroutine setservices(gc,rc)
     ...
     call MAPL_GetResource(MAPL, my_child_name, Label="my_child_name:",__RC)
     call MAPL_GetResource(MAPL, my_child_so, Label="my_child_so:",__RC)
     ...
     child1 = MAPL_AddChild(gc, my_child_name, "setservices_", sharedObj=my_child_so, __RC)
