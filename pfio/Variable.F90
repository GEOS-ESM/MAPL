...
module pFIO_VariableMod
   ...
   type :: Variable
      ...
      integer :: zstandard_level = 0 ! default no zstandard_level
...
contains
   ...
   function new_Variable(unusable, type, dimensions, chunksizes,const_value, deflation, zstandard_level, rc) result(var)
      type (Variable) :: var
   ...
   subroutine serialize(this, buffer, rc)
      ...
      buffer = [buffer, tmp_buffer,serialize_intrinsic(this%zstandard_level)]
