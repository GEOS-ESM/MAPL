...
contains
   ...
   subroutine handle_CollectivePrefetchData(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_CollectivePrefetchData should not be called")
      __UNUSED_DUMMY(this)
   ...
   subroutine handle_CollectiveStageData(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_CollectiveStageData should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_Terminate(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_Terminate should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_Done(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_Done should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_Done_prefetch(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_Done_prefetch should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_Done_collective_prefetch(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_Done_collective_prefetch should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_Done_stage(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_Done_stage should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_Done_collective_stage(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_Done_collective_stage should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_AddExtCollection(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_AddExtCollection should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_AddHistCollection(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_AddHistCollection should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_Id(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_ID should not be called. hint: maybe server and app are the same?")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_PrefetchData(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_PrefetchData should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_StageData(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_StageData should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_ModifyMetadata(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_ModifyMetadata should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_ReplaceMetadata(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_ReplaceMetadata should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
   ...
   subroutine handle_HandShake(this, message, rc)
      ...
      integer, optional, intent(out) :: rc
      __FAIL( "Warning : dummy handle_HandShake should not be called")
      __UNUSED_DUMMY(this)
      __UNUSED_DUMMY(message)
