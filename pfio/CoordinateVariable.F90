...
contains
   ...
   subroutine set_coordinate_data(this, coordinate_data, rc)
      ...
      __ASSERT(.not. allocated(this%coordinate_data), "use replace_coordinate_data") 
   ...
   subroutine get_real32(this, coordinate_data, unusable, rc)
      ...
      __ASSERT(allocated(this%coordinate_data), "not allocated coordinate data")
  ...
  subroutine serialize(this, buffer, rc)
   ...
   contains  
      ...
      subroutine deserialize(this, buffer, rc)
         ...
         __ASSERT(length == size(buffer), "size not match")
