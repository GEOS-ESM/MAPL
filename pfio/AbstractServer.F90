...
contains
   ...
   subroutine receive_output_data(this, rc)
     ...
     __FAIL(" no action of receive_output_data")
     __UNUSED_DUMMY(this)
   ...
   subroutine put_DataToFile(this, rc)
     class (AbstractServer),target, intent(inout) :: this
     integer, optional, intent(out) :: rc
     __FAIL(" no action of server_put_DataToFile")
     __UNUSED_DUMMY(this)
   ...
   subroutine get_DataFromMem(this,multi, rc)
     ...
     integer, optional, intent(out) :: rc
     __FAIL(" no action of server_get_DataFromMem")
     __UNUSED_DUMMY(this)
     __UNUSED_DUMMY(multi)
   ...
   subroutine report_profile(this, rc )
      ...
      call ioserver_profiler%stop(__RC)
